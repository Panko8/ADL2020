...
class Darknet(nn.Module):
    ...
    def forward(self, x):
        ...
        self.loss = None
        outputs = dict()
        maps = dict() # returned feature maps!
        out_boxes = []
        for block in self.blocks:
            ...
            ##print(ind, block['type'], x.shape) #useful!!
        ...
        if self.training:
            ...
            #    print(outputs[key].type(), outputs[key].shape)
            return out_boxes, maps
